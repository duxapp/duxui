...
export const ScrollViewManage = /*@__PURE__*/ pure(() => {
  ...
  const ScrollViewManage_ = ({ defaultRefresh = false, children }) => {
  ...
  ScrollViewManage_.context = context
  ScrollViewManage_.useContext = () => useContext(context)

  return ScrollViewManage_
})
